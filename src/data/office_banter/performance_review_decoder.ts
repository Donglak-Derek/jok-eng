  ...
  decoderItems: [
    {
      ...
      keywords: [
          { word: "need more visibility", definition: "Code for 'You work hard but nobody knows you; start marketing yourself'." }
      ]
    },
    {
      id: "pr2",
      ...
      keywords: [
          { word: "Exceeds Expectations", definition: "The highest rating; essentially a coupon to negotiate a raise." }
      ]
    },
    {
      id: "pr3",
      ...
      keywords: [
          { word: "too 'direct'", definition: "Being honest without enough diplomatic 'fluff'; seen as rude." }
      ]
    },
    {
      id: "pr4",
      ...
      keywords: [
          { word: "step up", definition: "Taking on more responsibility, usually without more pay." }
      ]
    },
    {
      id: "pr5",
      ...
      keywords: [
          { word: "Not a cultural fit", definition: "Vague, catch-all reason for rejection or firing." }
      ]
    },
    {
      id: "pr6",
      ...
      keywords: [
          { word: "Passionate", definition: "Euphemism for 'emotional' or 'difficult to work with'." }
      ]
    }
  ],
