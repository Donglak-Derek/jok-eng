    ...
    return (
        <div className="flex flex-col min-h-screen bg-background text-foreground">
            ...
            <main className="flex-1 flex flex-col pt-32 pb-20 px-6 max-w-3xl mx-auto w-full">
                <h1 className="text-4xl md:text-5xl font-black italic tracking-tighter mb-8 uppercase">About Amly</h1>
                
                <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                    <p>
                        Amly is designed for professionals and immigrants who already know English, but need to master the nuance, tone, and cultural subtext of American communication.
                    </p>
                    <p>
