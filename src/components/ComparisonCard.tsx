      ...
      <div className="flex-1 p-4 md:p-8 pt-6 flex flex-col gap-6 relative">
        ...
        {step === 0 && (
          <div className="flex-1 flex flex-col items-center justify-center min-h-[200px] animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <Button
              onClick={() => setStep(1)}
              className="rounded-2xl px-12 py-8 text-xl font-black uppercase tracking-widest bg-white text-black hover:scale-105 transition-all shadow-2xl shadow-primary/20"
            >
              Analyze Options
            </Button>
          </div>
        ...
        {step >= 1 && sentence.badResponse && (
          <motion.div
            ...
            animate={{ opacity: step === 2 ? 0.4 : 1, scale: 1, y: 0 }}
            className={`relative bg-rose-500/5 p-6 md:p-8 rounded-3xl border border-rose-500/20 shadow-2xl overflow-hidden`}
          >
            ...
            <div className="text-2xl md:text-3xl font-black leading-tight text-rose-100/40 text-left italic line-through decoration-rose-500/50 decoration-2">
        ...
        {step === 1 && (
          ...
          >
            <Button
              onClick={() => setStep(2)}
              className="rounded-2xl px-10 py-7 text-lg font-black uppercase tracking-widest bg-primary text-white hover:opacity-90 hover:scale-105 transition-all shadow-2xl shadow-primary/30"
            >
              Master The Response &rarr;
            </Button>
          </motion.div>
        )}
