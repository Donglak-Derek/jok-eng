    ...
    const autoSaveScript = useCallback(async (
        ...
        try {
            ...
            const userScript: Omit<UserScript, "id"> = {
                ...
                isPublic: false, // Default to private as per user request
                remixCount: 0,
                // Lineage
                        ...
                        <div className="pt-6">
                            ...
                            <div className="mt-3 text-center">
                                <button
                                    ...
                                    className={`text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full border transition-all ${canCreateScenario()
