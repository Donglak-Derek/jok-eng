...
export default function SNSCallout() {
  return (
    <div className="w-full bg-secondary/30 border border-border rounded-2xl p-6 md:p-8 flex flex-col items-center justify-center gap-6 text-center mt-8">
      <div>
        <h3 className="text-xl font-bold text-foreground mb-2">Join the Club!</h3>
        <p className="text-muted-foreground">Follow us for daily tips and updates.</p>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <Link 
            ...
            className="text-muted-foreground hover:text-black transition-colors p-3 hover:bg-white rounded-full border border-transparent hover:border-border hover:shadow-sm"
            title="TikTok"
        >
        ...
        <Link 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-pink-600 transition-colors p-3 hover:bg-white rounded-full border border-transparent hover:border-border hover:shadow-sm"
            title="Instagram"
        >
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-6 h-6">
        ...
        <Link 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-blue-700 transition-colors p-3 hover:bg-white rounded-full border border-transparent hover:border-border hover:shadow-sm"
            title="LinkedIn"
        >
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-6 h-6">
        ...
        <Link 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-red-600 transition-colors p-3 hover:bg-white rounded-full border border-transparent hover:border-border hover:shadow-sm"
            title="YouTube"
        >
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-6 h-6">
